To complete this lab, you will need to create an account at [Open Weather Map](https://openweathermap.org) and [follow the instructions to get an API key](https://openweathermap.org/appid).
